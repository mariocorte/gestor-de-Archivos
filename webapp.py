...
def index():
    ...
    context = {
        "form": {
            ...
            "sftp_password": defaults.sftp_password or "",
            "sftp_private_key": defaults.sftp_private_key or "",
            "sftp_passphrase": defaults.sftp_passphrase or "",
    ...
    if request.method == "POST":
        ...
        try:
            ...
            context["form"].update({
                ...
                "sftp_password": config.sftp_password or "",
                "sftp_private_key": config.sftp_private_key or "",
                "sftp_passphrase": config.sftp_passphrase or "",
